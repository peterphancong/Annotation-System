<template>
    <div class="text-sm">
        <h1 class="ml-2 text-3xl w-5/6">Annotation Board</h1>
        <div class="bg-white m-2">
          <div class="p-2" id="paragraph">
            <div class="flex flex-col">
              <h2 class="font-bold text-left w-5/6" id="title">Stem Cell-Derived Extracellular Vesicles and Kidney Regeneration <span>(PubMedID: 31614642)</span></h2>
            </div>
            <p class="p-1 border shadow-sm overflow-y-scroll overflow-auto h-40">
            ...
            <div class="mt-2 flex justify-left h-8">
              <select id="countries_disabled" class="text-sm border-b-1 border-gray-400 text-gray-900 rounded-lg block w-64 p-1">
          ...
          <div class="pl-2 pr-2" id="idnetifier_selection">
            <div class="text-sm p-1 border shadow-sm overflow-y-scroll text-base rounded-lg overflow-auto">
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">3175</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">3630</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">317</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">rs74805019</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">D008358</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">c|SUB|G|CODON1763|A</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">D008133</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">2</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">rs121908864</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">rs267607117</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">3175</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">3630</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">317</button>
              <button class="text-sm m-0.5 bg-gray-200 rounded-lg p-0.5 border-gray-500 hover:bg-gray-500">rs74805019</button>
          ...
          <div class="flex justify-between">
            <div class="p-2 m-2 w-1/2 border overflow-y-scroll bg-dark-gray">
